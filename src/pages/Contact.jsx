  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] flex items-center justify-center px-4 py-10">
      <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-10 w-full max-w-5xl">
        <h2 className="text-4xl font-bold text-white text-center mb-10">Get in Touch with <span className="text-red-400">Shopsy</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="text-white space-y-6">
            ...
            <div>
              <p><strong>📍 Address:</strong> Ahmedabad, Gujrat, India</p>
              <p><strong>📧 Email:</strong> support@shopsy.com</p>
              <p><strong>📞 Phone:</strong> +91 1234456789</p>
            </div>
          </div>
